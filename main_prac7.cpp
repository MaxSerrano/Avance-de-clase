...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	if(positional)
		glLightf(GL_LIGHT1, GL_SPOT_CUTOFF, LightAngle);			// Position The Light a,angulo de apartura q8ue tendra la luz(lightAngle)
	...
	glPushMatrix ();
		...
		glPushMatrix();
				...
				glMaterialfv(GL_FRONT, GL_AMBIENT, mat_ambient); //antes de l oque se va a dibujar
