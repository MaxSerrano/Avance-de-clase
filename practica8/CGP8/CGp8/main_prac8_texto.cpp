...
void prisma (GLuint textura1, GLuint textura2)  //Funcion creacion prisma *argumento de texturas
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Back
			glNormal3f( 0.0f, 0.0f,-1.0f);
			glTexCoord2f(0.78f, 0.35f); glVertex3fv(vertice[6]);
			glTexCoord2f(0.82f, 0.35f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.82f, 0.67f); glVertex3fv(vertice[3]);
			glTexCoord2f(0.78f, 0.67f); glVertex3fv(vertice[2]);
		glEnd();
